...
versionFile="./sources/DestinationFilters-Swift/Version.swift"
...
echo "DestinationFilters-Swift current version: $version"
...
# update sources/DestinationFilters-Swift/Version.swift
# - remove last line...
sed -i '' -e '$ d' $versionFile
# - add new line w/ new version
echo "internal let __destinationFilters_version = \"$newVersion\"" >> $versionFile
